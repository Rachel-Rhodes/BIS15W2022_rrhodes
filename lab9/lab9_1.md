...
##    taxon   common.name      class order family genus species primarymethod N    
##    <chr>   <chr>            <chr> <chr> <chr>  <chr> <chr>   <chr>         <chr>
##  1 mammals Northern three-… mamm… dide… didel… mono… americ… telemetry*    <NA> 
##  2 mammals southern grassh… mamm… roden crice… onyc… torrid… telemetry*    <NA> 
##  3 mammals salt marsh harv… mamm… rode… crice… reit… ravive… telemetry*    <NA> 
##  4 mammals wood mouse       mamm… rode… murid… apod… sylvat… telemetry*    <NA> 
##  5 mammals greater white-f… mamm… sori… soric… croc… russula telemetry*    <NA> 
##  6 mammals arctic shrew     mamm… sori… soric… sorex arctic… telemetry*    <NA> 
##  7 mammals cinereus shrew   mamm… sori… soric… sorex cinere… telemetry*    <NA> 
##  8 mammals crowned shrew    mamm… sori… soric… sorex corona… telemetry*    <NA> 
##  9 mammals slender shrew    mamm… sori… soric… sorex gracil… telemetry*    <NA> 
## 10 mammals long-clawed shr… mamm… sori… soric… sorex unguic… telemetry*    <NA> 
...
##    taxon   common.name      class order family genus species primarymethod N    
##    <chr>   <chr>            <chr> <chr> <chr>  <chr> <chr>   <chr>         <chr>
##  1 mammals American bison   mamm… arti… bovid… bison bison   telemetry*    <NA> 
##  2 mammals European bison   mamm… arti… bovid… bison bonasus telemetry*    <NA> 
##  3 mammals mountain goat    mamm… arti… bovid… orea… americ… telemetry*    <NA> 
##  4 mammals common eland     mamm… arti… bovid… taur… oryx    telemetry*    <NA> 
##  5 mammals giraffe          mamm… arti… giraf… gira… camelo… telemetry*    <NA> 
##  6 mammals horse            mamm… peri… equid… equus caball… telemetry*    <NA> 
##  7 mammals white rhinoceros mamm… peri… rhino… cera… simum   telemetry*    <NA> 
##  8 mammals black rhinoceros mamm… peri… rhino… dice… bicorn… telemetry*    <NA> 
##  9 mammals Asian elephant   mamm… prob… eleph… elep… maximus telemetry*    <NA> 
## 10 mammals African bush el… mamm… prob… eleph… loxo… africa… telemetry*    <NA> 
## # … with 15 more variables: mean.mass.g <dbl>, log10.mass <dbl>,
## #   alternative.mass.reference <chr>, mean.hra.m2 <dbl>, log10.hra <dbl>,
## #   hra.reference <chr>, realm <chr>, thermoregulation <chr>, locomotion <chr>,
## #   trophic.guild <chr>, dimension <dbl>, preymass <dbl>, log10.preymass <dbl>,
