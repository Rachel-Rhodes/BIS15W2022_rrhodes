...
## # … with 1 more variable: weight <dbl>
```
Bonus Question:The | operator means or, some heroes have a height greater than 300 and weight greater than 450. 
...
## # … with 724 more rows, and 2 more variables: weight <dbl>, h_to_w_ratio <dbl>
```
