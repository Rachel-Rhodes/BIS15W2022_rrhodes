...
```
## spec_tbl_df [3,690 × 8] (S3: spec_tbl_df/tbl_df/tbl/data.frame)
...
The data is "tidy" in which all the variables has its own row and column. The data is in long format.
